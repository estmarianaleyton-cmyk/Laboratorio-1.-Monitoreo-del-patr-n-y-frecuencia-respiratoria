...
Una vez verificado el montaje se realizaron dos adquisiciones. En la primera el participante permaneció en reposo respirando de manera natural durante 30 segundos. En la segunda el mismo participante realizó una lectura en voz alta durante el mismo tiempo, con el propósito de evaluar los cambios que producía la verbalización sobre el patrón respiratorio.
Finalizadas las adquisiciones, se procesaron para identificar los ciclos de inhalación y exhalación y obtener la frecuencia respiratoria correspondiente a cada condición. Finalmente se compararon los resultados obtenidos durante el reposo y durante la verbalización con el fin de analizar las diferencias en el comportamiento de la respiración.
